...
<body>
		...
		<div class="container">
			...
			<div class="form-group">
				<label for="categorySelect"
					class="col-sm-offset-1 col-sm-4 control-label">Select a
					category</label>
				<div class="col-sm-3">
			...
			<div class="form-group">
				<label for="sortSelect"
					class="col-sm-offset-1 col-sm-4 control-label">Sort causes
					by: </label>
				<div class="col-sm-3">
	...
	<!-- returned results grid -->
		<c:forEach var="myvar" items="${selectedPosts}" varStatus="counter">
